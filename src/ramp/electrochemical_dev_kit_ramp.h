...
#include <stdint.h>
    ...
    } ELECTROCHEMICAL_DEV_KIT_ramp_params;
    ...
    inline void ELECTROCHEMICAL_DEV_KIT_ramp_set_n_step_by_e_end(
    ...
    inline void ELECTROCHEMICAL_DEV_KIT_ramp_set_t_step_by_scan_rate(
        ELECTROCHEMICAL_DEV_KIT_ramp_params *const p,
 ...
 */
#define ELECTROCHEMICAL_DEV_KIT_DEFINE_RAMP(                                   \
    name,                                                                      \
    energy_type,                                                               \
    number_type,                                                               \
    time_type                                                                  \
